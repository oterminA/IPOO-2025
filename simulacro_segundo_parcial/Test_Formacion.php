...
$objVagon1 = new Vagon_Pasajeros(2013, 20, 3, 15000, 30, 25);
...
$objVagon2 = new Vagon_Pasajeros(2024, 20, 3, 15000, 50, 50);
...
$resultado = $objFormacion->incorporarPasajeroFormacion(90);
...
echo "Incorporacion de 14 pasajeros: \n";
$resultado = $objFormacion->incorporarPasajeroFormacion(200);
echo $resultado ? "Sucedió la incorporación. \n" : "Falló la incorporación. \n";
